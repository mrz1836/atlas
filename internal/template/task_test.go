...
func TestNewTaskTemplate(t *testing.T) {
	tmpl := NewTaskTemplate()
...
func TestTaskTemplate_StepOrder(t *testing.T) {
	tmpl := NewTaskTemplate()

	expectedSteps := []string{
		"implement", "verify", "validate", "git_commit",
...
func TestTaskTemplate_StepTypes(t *testing.T) {
	tmpl := NewTaskTemplate()
...
func TestTaskTemplate_RequiredSteps(t *testing.T) {
	tmpl := NewTaskTemplate()

	// In task template, verify step is optional by default
	optionalSteps := map[string]bool{
		"verify": true, // Verification is OFF by default for task
	}
...
func TestTaskTemplate_Timeouts(t *testing.T) {
	tmpl := NewTaskTemplate()
...
func TestTaskTemplate_RetryConfiguration(t *testing.T) {
	tmpl := NewTaskTemplate()
...
func TestTaskTemplate_ValidationCommands(t *testing.T) {
	tmpl := NewTaskTemplate()
...
func TestTaskTemplate_StepConfigurations(t *testing.T) {
	tmpl := NewTaskTemplate()
	...
	assert.Equal(t, "implement_task", implementStep.Config["prompt_template"])
